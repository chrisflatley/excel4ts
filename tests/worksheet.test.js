...
test('Verify Invalid Worksheet options fail type validation', (t) => {
  ...
  try {
    ...
    t.ok(e instanceof TypeError, 'setting invalid pageSetup.cellComments property should throw an error');
  }
  ...
  try {
    ...
    t.ok(e instanceof TypeError, 'setting invalid pageSetup.errors property should throw an error');
  }
  ...
  try {
    ...
    t.ok(e instanceof TypeError, 'setting invalid pageSetup.orientation property should throw an error');
  }
  ...
  try {
    ...
    t.ok(e instanceof TypeError, 'setting invalid pageSetup.pageOrder property should throw an error');
  }
  ...
  try {
    ...
    t.ok(e instanceof TypeError, 'setting invalid pageSetup.paperHeight property should throw an error');
  }
  ...
  try {
    ...
    t.ok(e instanceof TypeError, 'setting invalid pageSetup.paperSize property should throw an error');
  }
  ...
  try {
    ...
    t.ok(e instanceof TypeError, 'setting invalid pageSetup.paperWidth property should throw an error');
  }
  ...
  try {
    ...
    t.ok(e instanceof TypeError, 'setting invalid sheetView.pane.activePane property should throw an error');
  }
  ...
  try {
    ...
    t.ok(e instanceof TypeError, 'setting invalid sheetView.pane.state property should throw an error');
  }
  ...
  try {
    ...
    t.ok(e instanceof TypeError, 'setting invalid hidden property should throw an error');
  }
