...
class Font {
	...
	constructor(opts) {
		...
		typeof opts.color === "string"
			? (this.color = types.excelColor.getColor(opts.color))
			: null;
		...
		types.fontFamily.validate(opts.family) === true
			? (this.family = opts.family)
			: null;

		typeof opts.vertAlign === "string"
	...
	addToXMLele(fontXML) {
		...
		fEle
			.ele("color")
			.att("rgb", this.color !== undefined ? this.color : "FF000000");
		fEle
			.ele("name")
			.att("val", this.name !== undefined ? this.name : "Calibri");
		if (this.family !== undefined) {
			fEle
				.ele("family")
				.att("val", types.fontFamily[this.family.toLowerCase()]);
		}
