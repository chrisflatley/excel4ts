export class DefinedName {
  ...
  constructor(opts) {
    ...
    opts.localSheetId !== undefined
      ? (this.localSheetId = opts.localSheetId)
      : null;
    opts.hidden !== undefined ? (this.hidden = opts.hidden) : null;
    opts["function"] !== undefined
      ? (this["function"] = opts["function"])
      : null;
    opts.vbProcedure !== undefined
      ? (this.vbProcedure = opts.vbProcedure)
      : null;
    opts.xlm !== undefined ? (this.xlm = opts.xlm) : null;
    opts.functionGroupId !== undefined
      ? (this.functionGroupId = opts.functionGroupId)
      : null;
    opts.shortcutKey !== undefined
      ? (this.shortcutKey = opts.shortcutKey)
      : null;
    opts.publishToServer !== undefined
      ? (this.publishToServer = opts.publishToServer)
      : null;
    opts.workbookParameter !== undefined
      ? (this.workbookParameter = opts.workbookParameter)
      : null;
  }
  ...
  addToXMLele(ele) {
    ...
    this.customMenu !== undefined
      ? dEle.att("customMenu", this.customMenu)
      : null;
    this.description !== undefined
      ? dEle.att("description", this.description)
      : null;
    ...
    this.localSheetId !== undefined
      ? dEle.att("localSheetId", this.localSheetId)
      : null;
    this.name !== undefined ? dEle.att("name", this.name) : null;
    this["function"] !== undefined
      ? dEle.att("function", this["function"])
      : null;
    this.vbProcedure !== undefined
      ? dEle.att("vbProcedure", this.vbProcedure)
      : null;
    this.xlm !== undefined ? dEle.att("xlm", this.xlm) : null;
    this.functionGroupId !== undefined
      ? dEle.att("functionGroupId", this.functionGroupId)
      : null;
    this.shortcutKey !== undefined
      ? dEle.att("shortcutKey", this.shortcutKey)
      : null;
    this.publishToServer !== undefined
      ? dEle.att("publishToServer", this.publishToServer)
      : null;
    this.workbookParameter !== undefined
      ? dEle.att("workbookParameter", this.workbookParameter)
      : null;
